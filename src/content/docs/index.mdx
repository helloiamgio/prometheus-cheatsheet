...
template: splash
hero:
  tagline: Query PromQL per Kubernetes / OpenShift — organizzate per oggetto (Pod, Deploy, Node, Job, Network, Storage, Istio), pronte per troubleshooting WR, capacity planning e alerting.
  actions:
    - text: Inizia da Pod / Container
      ...
      variant: primary
    - text: GitHub
      link: https://github.com/helloiamgio/my-prometheus
      icon: external
---
